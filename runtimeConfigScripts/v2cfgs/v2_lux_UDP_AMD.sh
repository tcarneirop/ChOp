...
echo -e \#\#\# Building Chapel runtime 2.80 AMD GPU - $(rocm_agent_enumerator | grep -v gfx000 | sort -u | head -1) -  Multi Locale - $CHPL_COMM_SUBSTRATE   \#\#\#
echo " ### exporting...  ### "
...
make -j $NUM_T_LOCALE
echo -e \#\#\# DONE \#\#\# 
echo -e \#\#\# Chapel runtime 2.80 AMD GPU - $(rocm_agent_enumerator | grep -v gfx000 | sort -u | head -1) - Multi Locale - $CHPL_COMM_SUBSTRATE \#\#\#
