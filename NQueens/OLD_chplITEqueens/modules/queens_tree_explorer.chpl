...
module queens_tree_explorer{
    ...
    proc queens_subtree_explorer(const size: uint(16),const cutoff_depth: int(32), ref node: queens_node ):(uint(32),uint(32)){
        ...
        var number_sols: uint(32) = 0;
        var tree_size: uint(32) = 0;
        var _ONE_: uint(32) =  1;
