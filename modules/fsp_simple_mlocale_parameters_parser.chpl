module fsp_simple_mlocale_parameters_parser{
    ...
    use fsp_simple_multilocale_node_explorer;
	    ...
	    select atmc_type{
	            ...
	            select scheduler{
	                when "static" {
	                    forall n in distributed_active_set with (+ reduce metrics) do {
	                       metrics += fsp_simple_mlocale_global_atomic_node_explorer(machines,jobs,initial_depth,
	                            n, global_ub);
	                    }
	        ...
	        when "mixed"{
	            ...
	            select scheduler{
	                when "static" {
	                    forall n in distributed_active_set with (+ reduce metrics) do {
	                       metrics += fsp_simple_mlocale_array_node_explorer(machines,jobs,initial_depth,
	        ...
	        when "none"{
	            ...
	            select scheduler{
	                when "static" {
	                    forall n in distributed_active_set with (+ reduce metrics) do {
	                       metrics += fsp_simple_mlocale_node_explorer(machines,jobs,initial_depth,
	                           n,ub);
	                    }
