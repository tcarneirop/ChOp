module fsp_simple_call_improved_mlocale_search{


	use fsp_simple_multilocale_node_explorer;
	use fsp_simple_improved_prefix_gen;
	...
	proc fsp_simple_call_improved_mlocale_search(const machines: c_int,const jobs: c_int,
    	const initial_depth: c_int ,const second_depth: c_int,
    	const chunk: int, ref node: fsp_node,global_ub: c_int, ref tree_each_locale: [] uint(64)
		):(uint(64),uint(64)){
